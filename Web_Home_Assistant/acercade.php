...
SISTEMA INFORMÁTICO 
<br>
El sistema informático de control de luces RaspControl, es la interfaz que permite conectar al usuario con el sistema.
<br>
 El programa permitirá accionar las luces cuando el usuario pulse un evento de botón en la interfaz. Esta fue realizada con home asisstan según las características de la raspberry, ya que es multiplataforma, es decir puede ser ejecutado.
<br>
...
<br>
<br>
Placa de Interacción:
<br>
La placa de interacción es una tarjeta electrónica que permite conectar a la placa Raspberry con el sistema eléctrico de la casa.
